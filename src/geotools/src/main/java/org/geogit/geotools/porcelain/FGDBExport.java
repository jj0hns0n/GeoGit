...
/**
 * Exports features from a feature type into a file geodatabase.
 * 
 * @see ExportOp
 */
@Parameters(commandNames = "export", commandDescription = "Export to file geodatabase")
public class FGDBExport extends AbstractFGDBCommand implements CLICommand {

    @Parameter(description = "<featureType path> <file_database> <table>", arity = 2)
    ...
    protected void runInternal(GeogitCLI cli) throws Exception {
        ...
        try {
            ...
            cli.getConsole().println("Geodatabase folder does not exist.");
